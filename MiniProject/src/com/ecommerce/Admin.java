...
public class Admin {
	...
	void addNewProduct() throws SQLException {
			...
			con=MyConnection.getConnection();
			ps=con.prepareStatement("insert into productinfo(p_name,p_description,price,quantity) values(?,?,?,?)");
			ps.setString(1,name );
			ps.setString(2,desc);
			ps.setInt(3,price);
	...
	void orderDetail() throws SQLException {
		...
		if(all.equalsIgnoreCase("all")) {
			...
			System.out.println("enter email to search particular order details");
	...
	//System.out.println("1:update product details/n 2:add new product/n 3:delete product/n 4:check order details/n 5:check customer list/n 6:check quentity of products");
	System.out.println("1:Update product details");
	System.out.println("2:Add new product details");
	System.out.println("3:Delete product details");
	System.out.println("4:Check order details");
	System.out.println("5:Check customer list");
	System.out.println("6:Check Quantity of product list");
